...
| `query.grpc.server.tls.verifyClientCA`                    | Verify client connections against the supplied CA certificate.                                                                          | `true`                  |
...
| `query.grpc.server.tls.ca`                                | TLS CA to verify clients against - ignored if existingSecret is provided or verifyClientCA is false                                     | `""`                     |
...
| `storegateway.grpc.server.tls.verifyClientCA`                    | Verify client connections against the supplied CA certificate.                                                                                          | `true`                  |
...
| `storegateway.grpc.server.tls.ca`                                | TLS CA to verify clients against - ignored if existingSecret is provided or verifyClientCA is false                                                                             | `""`                        |
...
| `receive.grpc.server.tls.verifyClientCA`                    | Verify client connections against the supplied CA certificate.                                                                   | `true`                  |
...
| `receive.grpc.server.tls.ca`                                | TLS CA to verify clients against - ignored if existingSecret is provided or verifyClientCA is false                              | `""`                     |
